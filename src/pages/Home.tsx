...
const Home = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 flex flex-col items-center justify-center h-screen text-center">
      <div className="max-w-4xl w-full space-y-6 flex flex-col justify-between">
